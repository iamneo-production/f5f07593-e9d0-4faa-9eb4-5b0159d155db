...
(async () => {
  const browser = await puppeteer.launch({
    ...
    try{
    await page.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
    ...
    try{
    await page1.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
    ...
    try{
    await page2.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
  ...
  try{
  await page3.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
  ...
  try{
  await page4.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
  ...
  try{
  await page5.goto('https://8081-adccfaebedfefcdccaedfebaefadfa.project.examly.io/');
